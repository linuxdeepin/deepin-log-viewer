...
3. 選中某條日誌後，可查看該日誌的詳細訊息，包括主機名稱、行程號等。

![0|rsylog](fig/eu_homepage.png)
...
4. 選中某條日誌後，可查看該日誌的詳細訊息，包括主機名稱和詳細訊息等。
...
2. 在彈出的授權對話框中，輸入使用者密碼完成授權。
3. 查看啟動日誌的狀態和訊息。
4. 選中某條日誌後，可查看該日誌的詳細訊息，包括主機名稱、登入訊息等。
...
![0|dnflog](fig/eu_dnflog.png)

#### 查看Xorg日誌

1. 在日誌收集工具介面，單擊 **Xorg日誌**。
2. 查看Xorg日誌的時間和訊息。
3. 選中某條日誌後，列表下方會顯示該日誌的詳細訊息，包括時間、主機名稱和詳細訊息等。
...
3. 選中某條日誌後，可查看該日誌的詳細訊息，包括主機名稱、詳細訊息等。
...
3. 選中某條日誌後，可查看該日誌的詳細訊息，包括主機名稱、事件類型、使用者名稱和詳細訊息。

![0|power event](fig/eu_powerevent.png)
...
![0|power event](fig/eu_rightclick.png)
