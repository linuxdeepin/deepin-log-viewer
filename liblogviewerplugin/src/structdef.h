...
#if defined(LOGVIEWERPLUGIN_LIBRARY)
#  define LOGVIEWERPLUGIN_EXPORT Q_DECL_EXPORT
#else
#  define LOGVIEWERPLUGIN_EXPORT Q_DECL_IMPORT
#endif

//log viewer plugin space
//namespace logviewerpluginSpace {
