...
int main(int argc, char *argv[])
{
    ...
    qDebug() << fileDirStr;
    if (fileDirStr != "/var/log/kern.log" && fileDirStr != "/var/log/boot.log" && fileDirStr != "/var/log/dpkg.log" && fileDirStr != "/var/log/Xorg.0.log" && fileDirStr != (QDir::homePath() + "/.kwin.log") && fileDirStr != "dmesg" && fileDirStr != "/var/log/dnf.log") {
